...
NUCLEAR_VERSION := NuclearSlim-V$(ROM_VERSION_MAINTENANCE)-$(ROM_VERSION_STATUS)[$(ROM_VERSION)]-$(DEVICEVERSION)-$(ROM_POSTFIX)
NUCLEAR_MOD_VERSION := NuclearSlim-V$(ROM_VERSION_MAINTENANCE)-$(ROM_VERSION_STATUS)[$(ROM_VERSION)]-$(DEVICEVERSION)-$(ROM_POSTFIX)
